...
public class Update implements Serializable{
	...
	public static Update parse(JSONObject updateObject) throws AppException {
		try {
			Update update = new Update();
			update.versionCode = updateObject.getInt("versionCode");
			update.versionName = updateObject.getString("versionName");
			update.downloadUrl = updateObject.getString("downloadUrl");
