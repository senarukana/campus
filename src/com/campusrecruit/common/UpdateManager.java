...
public class UpdateManager {
	...
	public void checkAppUpdate(Context context, final boolean isShowMsg){
		...
		new Thread(){
			public void run() {
				...
				try {					
					Update update = NetApiClient.checkVersion((AppContext)mContext.getApplicationContext());
					msg.what = 1;
					msg.obj = update;
	...
	private Runnable mdownApkRunnable = new Runnable() {	
		...
		public void run() {
			try {
				String apkName = "CampusRecruitApp_"+mUpdate.getVersionName()+".apk";
				String tmpApk = "CampusRecruitApp_"+mUpdate.getVersionName()+".tmp";
				//判断是否挂载了SD卡
				String storageState = Environment.getExternalStorageState();		
				if(storageState.equals(Environment.MEDIA_MOUNTED)){
					savePath = Environment.getExternalStorageDirectory().getAbsolutePath() + "/CampusRecruit/Update/";
